...
const Input = React.forwardRef<HTMLInputElement, InputProps>(({ className = input.container, type, mode = "solid", sizes = "M", status = "default", iconBefore, iconAfter, outerStyle, ...props }, ref) => {
