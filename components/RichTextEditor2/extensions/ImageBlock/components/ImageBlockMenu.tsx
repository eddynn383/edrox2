...
import { MenuProps } from '@/components/RichTextEditor2/menus/types'
    ...
    return (
        ...
        >
            <Toolbar.Wrapper shouldShowContent={shouldShow()} ref={menuRef}>
                <Toolbar.Button tooltip="Align image left" selected={isImageLeft} onClick={onAlignImageLeft}>
                    <Icon name="AlignHorizontalDistributeStart" />
                </Toolbar.Button>
                <Toolbar.Button tooltip="Align image center" selected={isImageCenter} onClick={onAlignImageCenter}>
                    <Icon name="AlignHorizontalDistributeCenter" />
                </Toolbar.Button>
                <Toolbar.Button tooltip="Align image right" selected={isImageRight} onClick={onAlignImageRight}>
