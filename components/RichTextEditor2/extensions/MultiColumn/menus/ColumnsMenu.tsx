...
export const ColumnsMenu = ({ editor, appendTo }: MenuProps) => {
    ...
    return (
        ...
        >
            <Toolbar.Wrapper>
                <Toolbar.Button tooltip="Sidebar left" selected={isColumnLeft} onClick={onColumnLeft}>
                    <Icon name="PanelLeft" />
                </Toolbar.Button>
                <Toolbar.Button tooltip="Two columns" selected={isColumnTwo} onClick={onColumnTwo}>
                    <Icon name="Columns2" />
                </Toolbar.Button>
                <Toolbar.Button tooltip="Sidebar right" selected={isColumnRight} onClick={onColumnRight}>
